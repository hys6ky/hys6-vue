          ...
          <el-form-item :label="item.label + '：'" :prop="item.prop"  v-if="item.conceal === 'true' ? true : item.conceal === 'false' ? false : true">
            ...
            >
              ...
              <template slot="append" >
                <el-tooltip v-if="item.content" class="item" effect="dark" :content="item.content" :placement="item.placement || 'bottom'">
            ...
            <el-select
              ...
              :disabled="item.disabled"
              @change="selectChang(item.selectChang)"
            >
              <el-option
            ...
            <el-radio-group
              ...
              :disabled="item.disabled"
              @change="radioChange(item.radioChange,formData[item.prop])"
            >
              <el-radio
            ...
            <el-switch
              ...
              @change="$emit('swichChange',item.prop,formData[item.prop])"
            ></el-switch>
            <el-cascader
              v-model="formData[item.prop]"
...
export default {
  ...
  methods: {
    ...
    selectChang(selectChang){
      this.$emit('selectChang',selectChang);
    },
    radioChange(radioChange,data){
      this.$emit("radioChange",radioChange,data);
    }
  },
};
</script>
