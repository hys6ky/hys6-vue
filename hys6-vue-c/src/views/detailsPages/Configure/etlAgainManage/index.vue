<template>
    <el-form ref="form" :model="form">
        ...
        <div class="buttonStyle">
            <el-button size="meduim" type="primary" @click="saveEtlErrorResource('form')">保存
            </el-button>
        </div>
    </el-form>
</template>
    ...
    export default {
        ...
        methods: {
            saveEtlErrorResource(formName) {
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        this.$executeRequest.execGetByModuleUrl('/jobconfig/saveEtlErrorResource',params).then(res => {
                            if (res && res.success) {
            ...
            searchEtlErrorResource() {
                var data = { etl_sys_cd: this.$route.query.etl_sys_cd }
                this.$executeRequest.execGetByModuleUrl('/jobconfig/searchEtlErrorResource',data).then(res => {
                    if ("" != res.data) {
