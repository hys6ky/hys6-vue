...
export default {
    ...
    methods: {
        ...
        getSystemInfo() {
            ...
            this.$executeRequest.execGetByModuleUrl('/syslevelintervention/searchSystemBatchConditions',params).then(res => {
        ...
        getCurrInfo() {
            let params = {};
            params["etl_sys_cd"] = this.sys_cd;
            this.$executeRequest.execGetByModuleUrl('/syslevelintervention/searchSysLevelCurrInterventionInfo',params).then(res => {
                let dates = res.data;
                dates.forEach((item) => {
                    //干预类型
        ...
        getHistoryInfo() {
            ...
            this.$executeRequest.execGetByModuleUrl('/syslevelintervention/searchSysLeverHisInterventionByPage',params).then(res => {
        ...
        savePause() {
            ...
            this.$executeRequest.execGetByModuleUrl('/syslevelintervention/sysLevelInterventionOperate',params).then(res => {
                if (res && res.success) {
                    this.getSystemInfo();
                    this.getCurrInfo();
                    this.getHistoryInfo();
