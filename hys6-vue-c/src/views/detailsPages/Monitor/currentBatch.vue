...
export default {
    ...
    methods: {
        ...
        monitorCurrentBatchInfo() {
            this.$executeRequest.execGetByModuleUrl('/etlmonitor/monitorCurrentBatchInfo',{
        ...
        monitorCurrentBatchInfoByTask() {
          this.$executeRequest.execGetByModuleUrl('/etlmonitor/monitorCurrentBatchInfoByTask',{
                etl_sys_cd: sessionStorage.getItem("sys_cd")
            }).then((res) => {
                if(res && res.success){
        ...
        searchMonitorJobStateBySubCd(val) {
            let that = this;
          this.$executeRequest.execGetByModuleUrl('/etlmonitor/searchMonitorJobStateBySubCd',{
                etl_sys_cd: sessionStorage.getItem("sys_cd"),
                sub_sys_cd: val,
