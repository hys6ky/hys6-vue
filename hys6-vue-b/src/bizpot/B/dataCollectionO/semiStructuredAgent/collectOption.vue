        ...
        methods: {
            ...
            searchObjectCollect() {
                if (this.$route.query.id) {
                    // 更新初始页面
                    this.$executeRequest.execGetByMenuUrl("/semiStructuredAgent/getObjectCollectConfById", {
                    ...
                    // 新增初始页面
                    this.$executeRequest.execGetByMenuUrl("/semiStructuredAgent/getAddObjectCollectConf", {
            ...
            getInitObjectCollectConf() {
                this.$executeRequest.execGetByMenuUrl("/semiStructuredAgent/getInitObjectCollectConf", {
                    agent_id: this.$route.query.agent_id
                }).then(res => {
            ...
            // 查看表信息
            viewTable() {
                this.$executeRequest.execGetByMenuUrl("/semiStructuredAgent/viewTable", {
                    ...
                    if (this.$route.query.id) { //更新
                        this.$refs[formName].validate(valid => {
                            if (valid) {
                                ...
                                this.$executeRequest.execGetByMenuUrl("/semiStructuredAgent/saveObjectCollect", this.form).then(res => {
