<template>
    <div>
        ...
        <el-pagination @size-change="clean_handleSizeChange" @current-change="clean_handleCurrentChange"
                       :current-page="cleancurrentPage" :page-sizes="[50, 100, 150, 200]" :page-size="cleanpagesize"
        ...
        <el-dialog title="列清洗" :visible.sync="dialogColClean" width="70%" class="alltable" @close="selectColCloseFun()">
            ...
            <div slot="footer" class="dialog-footer">
                <el-table stripe
                    ...
                    <el-table-column label="清洗优先级" align="center" width="140">
                        <template slot-scope="scope">
                    ...
                    <template slot-scope="scope">
                        ...
                        <div class="demo-input-suffix" v-if="scope.row.split_type==2">
                          <el-tooltip class="item" effect="light" content placement="right">
                            ...
                            <i class="el-icon-question" aria-hidden="true">值位置：</i>
                          </el-tooltip>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.tableHeight = window.screen.height - 325
        },
        mounted() {
            // 获取进入页面的总数据
        ...
        methods: {
            ...
            next() {
                ...
                if (tbCleanString.length > 0) {
                    ...
                    this.$executeRequest.execPostByModuleUrl("/dataCollectionO/agent/cleanconf/saveDataCleanConfig", params).then(res => {
            ...
            cleantableDataFun() {
                ...
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getCleanConfInfo", params).then(res => {
            ...
            alltableClean(id) {
                ...
                params["colSetId"] = id;
                // 字符替换
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getAllTbCleanReplaceInfo", params).then(res => {
                    //addTaskAllFun.getAllTbCleanReplaceInfo(params).then(res => {
                    this.allTableCleanSettingData = res.data ? res.data : [];
                });
                // 字符补齐
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getAllTbCleanCompInfo", params).then(res => {
            ...
            saveAllTbCleanConfigInfo() {
                ...
                let params = {};
                params["oriFieldArr"] = JSON.stringify(arr1);
                params["replaceFeildArr"] = JSON.stringify(arr2);
                ...
                this.$executeRequest.execPostByModuleUrl("/dataCollectionO/agent/cleanconf/saveAllTbCleanConfigInfo", params).then(res => {
            ...
            allTableCleanPriorityFun(id) {
                ...
                let params = {};
                params["colSetId"] = this.colSetid;
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getAllTbCleanOrder", params).then(res => {
            ...
            allTableCleanPrioritySubmitFun() {
                ...
                params["colSetId"] = this.colSetid;
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/saveAllTbCleanOrder", params).then(res => {
            ...
            selectColPageFun(id) {
                ...
                params["tableId"] = id;
                this.tableloadingInfo = "数据加载中...";
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getColumnInfo", params).then(res => {
            ...
            selectColSubmitFun() {
                this.dialogColClean = false;
                let colCleanParam = this.getdata();
              // params["colCleanString"] = JSON.stringify(colCleanString);
                this.$executeRequest.execPostByModuleUrl("/dataCollectionO/agent/cleanconf/saveColCleanConfig", colCleanParam).then(res => {
            ...
            table_zfbqFun(index, tableid, compflags) {
                ...
                if (compflags != 0) {
                    ...
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getTbCompletionInfo", params).then(res => {
            ...
            Table_zfbqsubmit(formName) {
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        this.$executeRequest.execPostByModuleUrl("/dataCollectionO/agent/cleanconf/saveSingleTbCompletionInfo", params).then(res => {
            ...
            table_zfthFun(index, tableid, compflags) {
                ...
                if (compflags != 0 || compflags) {
                    let params = {};
                    params["tableId"] = tableid;
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getSingleTbReplaceInfo", params).then(res => {
            ...
            Table_zfthsubmit() {
                ...
                this.$executeRequest.execPostByModuleUrl("/dataCollectionO/agent/cleanconf/saveSingleTbReplaceInfo", params).then(res => {
            ...
            zfbqFun(index, row) {
                ...
                if (row.compflag != 0) {
                    ...
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getColCompletionInfo", params).then(res => {
            ...
            Col_zfbqSubmitFun(formName) {
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/saveColCompletionInfo", params).then(res => {
            ...
            zfthFun(index, row) {
                ...
                if (row.replaceflag != 0) {
                    let params = {};
                    params["columnId"] = row.column_id;
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getColReplaceInfo", params).then(res => {
            ...
            Col_zfthSubmitFun() {
                ...
                this.$executeRequest.execPostByModuleUrl("/dataCollectionO/agent/cleanconf/saveColReplaceInfo", params).then(res => {
            ...
            rqgshFun(index, row) {
                ...
                if (row.formatflag != 0) {
                    let params = {};
                    params["columnId"] = row.column_id;
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getDateFormatInfo", params).then(res => {
            ...
            Col_rqgshSubmitFun() {
                ...
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/saveDateFormatInfo", params).then(res => {
            ...
            colcfFun(index, row) {
                ...
                if (row.splitflag != 0) {
                    let params = {};
                    params["columnId"] = row.column_id;
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getColSplitInfo", params).then(res => {
            ...
            Col_colcfSubmitFun() {
                ...
                this.$executeRequest.execPostByModuleUrl("/dataCollectionO/agent/cleanconf/saveColSplitInfo", params).then(res => {
            ...
            Col_colcfDelFun(index, rows) {
                if (rows[index].col_clean_id && rows[index].col_split_id) {
                    ...
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/deleteColSplitInfo", params).then(res => {
            ...
            mzzhFun(index, row) {
                ...
                if (row.codevalueflag) {
                    let params = {};
                    params["columnId"] = row.column_id;
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getCVConversionInfo", params).then(res => {
                        ...
                        if (res.success) {
                            ...
                            this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getCVInfo", params).then(res => {
                ...
                //获取所有码值转换系统名称下拉选
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getSysCVInfo", null).then(res => {
            ...
            Col_mzzh_currentSel(v) {
                if (v == "选择系统名称") {
                    ...
                    this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getCVClassifyBySysCode", params).then(res => {
            ...
            Col_mzzhSubmitFun() {
                ...
                params["codesys"] = this.Col_mzzh[0].orig_sys_name
                    .split("(")[1]
                    .split(")")[0];
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/saveCVConversionInfo", params).then(res => {
            ...
            yxjFun(index, row) {
                ...
                params["columnId"] = this.columnid;
                params["tableId"] = this.tableid;
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getColCleanOrder", params).then(res => {
            ...
            Col_yxjSubmitFun() {
                ...
                params["columnId"] = this.columnid;
                params["sort"] = this.priSubmitFun(ordarr);
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/saveColCleanOrder", params).then(res => {
            ...
            allTableOrd() {
                ...
                params["tableId"] = this.tableid;
                params["colSetId"] = this.databaseId;
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getSingleTbCleanOrder", params).then(res => {
            ...
            AlltableCleanOrdSubmitFun() {
                ...
                params["tableId"] = this.tableid;
                params["sort"] = this.priSubmitFun(ordarr);
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/saveSingleTbCleanOrder", params).then(res => {
            ...
            columnMergeFun() {
                ...
                params["tableId"] = this.tableid;
                this.tableloadingInfo = "数据加载中...";
                this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/getColMergeInfo", params).then(res => {
            ...
            columnMergeSubmitFun() {
                ...
                this.$executeRequest.execPostByModuleUrl("/dataCollectionO/agent/cleanconf/saveColMergeInfo", params).then(res => {
            ...
            columnMergeDelFun(index, rows) {
                if (rows[index].col_merge_id) {
                    message.confirmMsg('确定删除吗').then(res => {
                        ...
                        this.$executeRequest.execGetByModuleUrl("/dataCollectionO/agent/cleanconf/deleteColMergeInfo", params).then(res => {
