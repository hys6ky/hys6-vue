<template>
    <div class="singlesearch">
                ...
                <div id="singleTable">
                    ...
                    <div class="singleTableinner">
                        <el-table ref="ty_Table" stripe :default-sort="{prop: 'date', order: 'descending'}"
                            ...
                            <el-table-column prop="selectCol" label="是否使用前缀" align="center">
                              ...
                              <template slot-scope="scope">
                                <el-checkbox type="selection" :true-label="IsFlag.Shi" :false-label="IsFlag.Fou"
                                             v-model="scope.row.is_prefix"></el-checkbox>
                              </template>
                            </el-table-column>
        ...
        <!-- 第一个页面 选择列弹层 -->
        <el-dialog title="查看列" :visible.sync="dialogSelectColumn" width="60%">
            <div slot="title" class="header-title">
                <span class="dialogtitle el-icon-caret-right">查看列</span>
            ...
            <el-table ref='table' stripe :data="SelectColumnData" border size="medium" highlight-current-row>
                ...
                <el-table-column property="column_type" label="字段类型" align="center"
                                 :show-overflow-tooltip="true"></el-table-column>
                <el-table-column property="column_ch_name" label="列中文名" align="center">
                    <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            ...
            allPrefix(e) {
              ...
              console.log(this.selectTable,"this.selectTable-选中的表")
              this.Allis_prefix = e
            },
            // 获取表格数据
            getTableData() {
                ...
                if (val != "") {
                    ...
                    this.$executeRequest.execGetByMenuUrl("/agent/isolate/getTableInfo", params).then(res => {
                        ...
                        if (res.data.length > 0) {
                            ...
                            this.tableData = res.data;
                            console.log(this.tableData,"this.tableData-搜索")
                        } else {
                            this.tableData = [];
                        }
                    });
            ...
            getAllTableInfo() {
                ...
                this.$executeRequest.execGetByMenuUrl("/agent/isolate/getAllTableInfo", params).then(res => {
                    ...
                    console.log(this.tableData,"this.tableData-查看全表")
                });
            },
            // 选择列
            ...
            finshSubmit() {
                ...
                let is_prefixs = [];
                this.selectTable.forEach(item => {
                  is_prefixs.push(item.is_prefix)
                })
                params['is_prefixs'] = is_prefixs;
                console.log(is_prefixs,"is_prefixs");
