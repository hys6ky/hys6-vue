...
const historyColumnArr = [
  ...
  { label: "标准中文名", prop: "CHname", type: "text", width: "120px" },
  { label: "标准英文名", prop: "ENname", type: "text", minWidth: "120px" },
  { label: "版本编号", prop: "verSionNum", type: "link", width: "120px" },
  { label: "版本状态", prop: "verSionStatus", type: "tag", width: "120" },
  { label: "发布时间", prop: "onlineTime", type: "text", width: "200px" },
  { label: "下线时间", prop: "offlineTime", type: "text", width: "200px" },
];
...
const rulesModelFormItems = [
  ...
  {
    prop: "referStandardName",
    label: "参照对象标准名称",
    type: "input",
    span: 12,
  },
  {
    prop: "qualityStandardDesc",
    label: "数据质量标准描述",
    type: "textarea",
    span: 24,
  },
...
const rulesModelFormRules = {
  ...
  department: { required: true, message: "该输入项为必填项", trigger: "blur" },
  referStandardNum: {
    required: true,
    message: "该输入项为必填项",
    trigger: "blur",
