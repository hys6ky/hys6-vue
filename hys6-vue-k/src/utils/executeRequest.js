 ...
 * @return  返回下文件的下载流
 */
export function downloadGetFileAllMappingNameParams(url, params) {
  return request({
    url: getGateWayPrefix() + checkPreFixDelimiter(url),
    params: params,
    responseType: "blob",
 ...
 * @return  返回下文件的下载流
 */
export function downloadPostFileAllMappingNameParams(url, params) {
  return request({
    url: getGateWayPrefix() + checkPreFixDelimiter(url),
    data: params,
    responseType: "blob",
...
export function uploadFileAllMappingName(url, params) {
  return request({
    url: getGateWayPrefix() + checkPreFixDelimiter(url),
    method: "post",
    data: params,
 ...
 * @return  返回下文件的下载流
 */
export function downloadPostFile(url, params) {
  return request({
    url: getRequestPathPrefix() + checkPreFixDelimiter(url),
    data: params,
    responseType: "blob",
