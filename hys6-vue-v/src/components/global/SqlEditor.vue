...
export default {
  ...
  mounted() {
    ...
    console.log(editor.setTheme,'1234567890987654323456789')
  ...
  methods: {
    ...
    getTablename() {
      //获取sql查询的全部表名
      // this.$executeRequest.execPostByModuleUrl("/webSqlConsole/websqlquery/getAllTableNameByPlatform")
      //   .then((res) => {
      //     let arr = [];
    ...
    getTableNameWords(execute_sql) {
      ...
      // this.$executeRequest.execPostByModuleUrl("webSqlConsole/websqlquery/getTableColumnInfoBySql", param)
      //   .then((res) => {
      //     if (res && res.success) {
      //       let arr = [];
      //       let arry = [];
