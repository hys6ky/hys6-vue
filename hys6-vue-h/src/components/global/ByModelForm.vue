        ...
        >
          ...
          >
            ...
            <el-color-picker
              ...
              :disabled="item.disabled"
            ></el-color-picker>
            <div v-else-if="item.type === 'otherDefined'">
              <slot :name="item.prop + 'Slot'"></slot>
            </div>
          ...
          <div v-else-if="item.type === 'listInForm'">
            <slot :name="item.prop + 'Slot'"></slot>
          </div>
        </el-col>
      </el-row>
...
.byModelForm {
  ...
  ::v-deep .formWrap .el-form-item__content {
    height: 40px;
    display: flex;
    align-items: center;
  }
