      ...
      <el-row v-for="(v, j) in formList" :key="j">
        ...
        >
          ...
          >
            ...
            ></el-input>
						<div class="d-flex" v-else-if="item.type === 'inputFanw'">
							<el-input
              v-model="formData[item.prop]['qs']"
              :placeholder="item.placeholder || '请输入'"
              :disabled="item.disabled"
              class="groupInput"
            ></el-input> <span class="ml-10 mr-10">~</span>
						<el-input
              v-model="formData[item.prop]['js']"
              :placeholder="item.placeholder || '请输入'"
              :disabled="item.disabled"
              class="groupInput"
            ></el-input>
						</div>
						<el-input-number v-else-if="item.type === 'el-input-number'" v-model.number="formData[item.prop]" controls-position="right" :min="0" :max="10"></el-input-number>
